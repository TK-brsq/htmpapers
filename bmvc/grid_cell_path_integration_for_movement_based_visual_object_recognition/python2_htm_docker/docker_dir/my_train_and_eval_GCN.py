...
def object_learning_and_inference(
        ...
        locationModuleWidth,#50
        feature_columns_to_grid_cells_threshold,#16
        grid_cells_to_feature_columns_threshold,#0.9, 36(0.9*40)
        bumpType,
        cellCoordinateOffsets,
        cellsPerColumn,#32
        activeColumnCount,#29
        columnCount,#128
        featuresPerObject,#25
        objectWidth,#5
        numModules,#40
        seed1,
        seed2,
    ...
    for i in range(numModules):
        ...
        config = {
            ...
            "activationThreshold": feature_columns_to_grid_cells_threshold,#16
            "initialPermanence": 1.0,
            "connectedPermanence": 0.5,
            "learningThreshold": feature_columns_to_grid_cells_threshold,#16
    ...
    #train_objects = [{}{}{}{}{}{}...{}] len(train_objects)=num/class * 10
    #train_objects[x] = {feature: list of patch infromations, name: label+idx}
    #
    ...
    #==========================================================
    print("\nLearning objects")
    for learning_object_iter in range(1):  # noqa: N806
        ...
        for threshold_iter in range(len(THRESHOLD_LIST)):
            ...
            for class_threshold_iter in CLASS_THRESHOLDS_LIST:
                ...
                for num_flip_bits in FLIP_BITS_LIST:
                    ...
                    all_results = object_learning_and_inference(
                        ...
                        # SDRs
                        activeColumnCount=20,  # Number of non-zero values in the
                        # input feature SDRs
                        cellCoordinateOffsets=cellCoordinateOffsets,
